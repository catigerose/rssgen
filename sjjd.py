...
if __name__ == '__main__':
    ...
    feed_title = "数据解读-国家统计局"  # feed的标题，会显示在feed阅读器中
    feed_description = "国家统计局数据-数据解读"  # feed的描述
    feed_name =  "sjjd.xml"  # feed xml文件的的名字
    website_url = 'https://www.stats.gov.cn/sj/sjjd/'  # 要爬取的页面
    ...
    news_list = get_soup(website_url,1).find("div",class_="list-content").find_all("li")
    ...
    for news in news_list:
        ...
        if guid not in guids:             
            ...
            news_detail = get_soup(news_url).find("div",class_="mobile-news-content").decode().replace('src="./',news_url_base) 
