...
if __name__ == '__main__':
    ...
    feed_descriptions = ["外汇新闻快讯_外汇实时新闻资讯网_英为财情Investing.com", "股市新闻_今日股市最新消息_股票新闻头条_英为财情Investing.com", "经济新闻_每日经济新闻快讯_英为财情Investing.com", "全球宏观经济指标新闻报道_最新财经数据资讯_英为财情Investing.com", "期货新闻_全球最新商品、股指、外汇期货资讯一览_英为财情Investing.com"]  # feed的描述
    feed_names = ["forex_news.xml", "stock_market_news.xml", "economy_investing.xml",  "economic_indicators.xml", "commodities_news.xml"]  # feed xml文件的的名字
    website_urls = ['https://cn.investing.com/news/forex-news', 'https://cn.investing.com/news/stock-market-news', 'https://cn.investing.com/news/economy',    'https://cn.investing.com/news/economic-indicators', 'https://cn.investing.com/news/commodities-news']  # 要爬取的页面
